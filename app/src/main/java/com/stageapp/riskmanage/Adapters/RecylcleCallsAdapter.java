...
public class RecylcleCallsAdapter extends RecyclerView.Adapter<RecylcleCallsAdapter.ViewHolder> {
    Context context;
    ...
    public RecylcleCallsAdapter(Context context) {
    ...
    public void addItems(ArrayList<Call> list) {
        this.mDataset.addAll(list);
        notifyItemRangeInserted(this.mDataset.size(), list.size());
    }
//
    public void reData(ArrayList<Call> list) {
        this.mDataset = list;
    ...
    public void onBindViewHolder(ViewHolder viewHolder,final int i) {
        ...
        viewHolder.app_name_tv.setText(this.mDataset.get(i).callName);
        ...
        viewHolder.icon_img.setImageDrawable(this.mDataset.get(i).callIcon);
